...
namespace UnitTest.ViewModel.Impl
{
    internal class DirectoryService : IDirectoryService
    {
        ...
        public string GetDbPath()
        {
            ...
            var dbDir = Path.Combine(myDir, "ViewModelTestDatabaseDir");
        ...
        {
            var myDir = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
            var cacheDir = Path.Combine(myDir, "ViewModelTestDirCache");
        ...
        {
            var myDir = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
            var dataDir = Path.Combine(myDir, "ViewModelTestDataDir");
