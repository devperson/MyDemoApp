...
namespace Base.Impl.Droid.UI.Utils
{
    public static class ContextExtensions
    {
        ...
        public static void ShowKeyboard(this Context self, Android.Views.View view)
        {
            var service = (InputMethodManager)self.GetSystemService(Context.InputMethodService);
        ...
        internal static void SetDesignerContext(Android.Views.View view)
        {
            _isDesignerContext = view.IsInEditMode;
        }

        internal static bool IsDesignerContext(this Android.Views.View view)
        {
            if (!_isDesignerContext.HasValue)
