namespace Base.Impl.iOS.UI.Controls.BootmSheet
{
    public class BottomSheetViewController : UIViewController, IUIGestureRecognizerDelegate
    {
        ...
        private void Panned(UIPanGestureRecognizer gesture)
        {
        ...
        public bool ShouldBegin(UIGestureRecognizer recognizer)
        {
            ...
            if (panGestureRecognizer == null || childScrollView == null || point == CGPoint.Empty)
            {
                return true;
            }
