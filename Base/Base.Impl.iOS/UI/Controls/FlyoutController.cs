...
namespace KYChat.iOS.Controls
{
    public partial class FlyoutController : UIViewController
    {
        ...
        public FlyoutController() : base("FlyoutController", null)
        {
        }

        public FlyoutController(UIViewController mainViewcontroller, UIViewController leftViewController,
    ...
    {
        public static nfloat LeftViewWidth = 250.0f;
        public static nfloat LeftBezelWidth = 16.0f;
        public static nfloat ContentViewScale = 1f;
        ...
        public static nfloat AnimationDuration = 0.15f;
