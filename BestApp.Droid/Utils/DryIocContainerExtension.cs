...
{
    internal class DryIocContainerExtension : IContainerExtension<IContainer>, IContainerInfo
    {
        private DryIocScopedProvider _currentScope;

        public static IContainerExtension CreateInstance()
        {
            var instance = CreateContainerExtension();
            return instance;
        }
        ...
        private static Rules CreateContainerRules() => DryIocContainerExtension.DefaultRules;
